...
#Ejemplo de creación de un dataframe de todas las estadisticas de una liga seleccionada para todos los equipos, 
#el primero a favor y el segundo en contra (aplicando el stats_vs) para las estadísticas de los jugadores de campo.

#PASOS PARA PODER ELEGIR LA URL DESEADA:

# 1: Elegir liga dispoible en player_urls: ['La Liga', 'Premier League', 'Serie A', 'League 1', 'Bundesliga']
liga_equipos_estadisticas = 'La Liga'

# 2: Elegir la temporada disponible en player_urls: ['2024-2025', '2023-2024', '2022-2023', '2021-2022', '2020-2021']
temporada_equipos_estadisticas= '2024-2025'

# 3: Creacion de la url para la funcion:
urls_equipos = teams_urls[liga_equipos_estadisticas][temporada_equipos_estadisticas]
print("URLS DISPONIBLES:", urls_equipos)
print('------')


#PRUEBAS DE USOS
print("\n🔹 Probando función para crear el dataframe de los equipos de una liga con todas las estadísticas de los jugadores de campo de la temporada.")
print(' ')
df_equipos, df_equiposvs= creacion_df_general_estadisticas_equipos(urls_equipos, stats_vs=False, guardar_csv=True,guardar_csv_individuales=False, league=liga_equipos_estadisticas, season=temporada_equipos_estadisticas)
print(df_equipos.sample(3))
print('------')
print(' ')

print("\n🔹 Probando función para crear el dataframe de los equipos_vs de una liga con todas las estadísticas de los jugadores de campo de la temporada.")
print(' ')
df_equipos, df_equiposvs= creacion_df_general_estadisticas_equipos(urls_equipos, stats_vs=True, guardar_csv=True,guardar_csv_individuales=False, league=liga_equipos_estadisticas, season=temporada_equipos_estadisticas)
print(df_equiposvs.sample(3))
print('------')
print(' ')
...
#Ejemplo de creación de un dataframe de todas las estadisticas de una liga seleccionada para todos los equipos, 
#el primero a favor y el segundo en contra (aplicando el stats_vs) para las estadísticas de los porteros
...
print("\n🔹 Probando función para crear el dataframe de los equipos de una liga con todas las estadísticas de los jugadores de campo de la temporada.")
print(' ')
df_porteros, df_porteros_vs= creacion_df_general_estadisticas_equipos_porteros(urls_equipos, stats_vs=False, guardar_csv=True,guardar_csv_individuales=False, league=liga_equipos_estadisticas, season=temporada_equipos_estadisticas)
print(df_porteros.sample(3))
print('------')
print(' ')

print("\n🔹 Probando función para crear el dataframe de los equipos_vs de una liga con todas las estadísticas de los jugadores de campo de la temporada.")
print(' ')
df_porteros, df_porteros_vs= creacion_df_general_estadisticas_equipos_porteros(urls_equipos, stats_vs=True, guardar_csv=True,guardar_csv_individuales=False, league=liga_equipos_estadisticas, season=temporada_equipos_estadisticas)
print(df_porteros_vs.sample(3))
print('------')
print(' ')
